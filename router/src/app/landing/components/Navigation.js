    ...
    <nav className="fixed top-0 z-50 w-full bg-[#181411]/80 backdrop-blur-md border-b border-[#3a2f27]">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a className="text-gray-300 hover:text-white text-sm font-medium transition-colors" href="https://github.com/yethikrishna/free-swarm#readme" target="_blank" rel="noopener noreferrer">Docs</a>
          <a className="text-gray-300 hover:text-white text-sm font-medium transition-colors flex items-center gap-1" href="https://github.com/yethikrishna/free-swarm" target="_blank" rel="noopener noreferrer">
        ...
        <div className="flex items-center gap-4">
          <button 
            ...
            className="hidden sm:flex h-9 items-center justify-center rounded-lg px-4 bg-[#D97757] hover:bg-[#c2654a] transition-all text-[#181411] text-sm font-bold shadow-[0_0_15px_rgba(217,119,87,0.4)] hover:shadow-[0_0_20px_rgba(217,119,87,0.6)]"
          >
            Get Started
          </button>
          <button 
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-[#3a2f27] bg-[#181411]/95 backdrop-blur-md">
          <div className="flex flex-col gap-4 p-6">
            ...
            <button 
              onClick={() => router.push("/dashboard")}
              className="h-9 rounded-lg bg-[#D97757] hover:bg-[#c2654a] text-[#181411] text-sm font-bold"
            >
              Get Started
            </button>
          </div>
